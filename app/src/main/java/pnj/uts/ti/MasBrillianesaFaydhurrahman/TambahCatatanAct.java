...
public class TambahCatatanAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actTambahDataCatatan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(CheckPermission()){
                    buatData();
                    Toast.makeText(TambahCatatanAct.this, "Penyimpanan data berhasil!", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(TambahCatatanAct.this, "Penyimpanan data gagal!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        switch (requestCode){
            case request_code:
                if(grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    Toast.makeText(TambahCatatanAct.this, "Izin Berhasil", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
